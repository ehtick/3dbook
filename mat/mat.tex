...
\begin{figure}
	...
	\begin{subfigure}[t]{0.310\linewidth}
		...
		\caption{Terrain points (from blue=low to red=high)}
	...
	\end{subfigure}
	\caption[The MAT approximation of a lidar terrain point cloud]{The MAT approximation (a,c) of a lidar terrain point cloud (b) obtained with the shrinking-ball algorithm. Top view. A video of the same dataset is available \href{https://vimeo.com/127577620}{here}.}
	\label{fig:ca_ridge}
\end{figure}
